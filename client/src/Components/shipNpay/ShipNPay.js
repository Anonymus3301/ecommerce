  ...
  return (
    <div className="ShipNPay">
      ...
      <div className="info">
        ...
        <div className="laNpo">
          <span className="lastname box">
            <input type="text" placeholder="Last Name"></input>
          </span>
          <span className="postal box">
        ...
        <div className="phNco">
          ...
          <span className="country box">
            <select defaultValue={"Poland"} id="country" name="country">
